                                ...
                                <Col xs={24} lg={12}>
                                    ...
                                    >
                                        <Paragraph
                                            ...
                                            lg="23px"
                                        >
                                            We’re not just a common NFT project,
                                            we’re creating an ecosystem where
                                            your NFT’s is more than Art, we
                                            think in our community and we want
                                            to give you a little piece back for
                                            the trust put in the project. <br />{' '}
                                            The token reward you in the
                                            ...
                                            easy to use. Wait for the token
                                            listing
                                        </Paragraph>
                                    </LineWrapper>
                                </Col>
